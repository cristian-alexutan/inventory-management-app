...
template <> constexpr inline auto User::qt_create_metaobjectdata<qt_meta_tag_ZN4UserE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onCycleAllClicked",
        "",
        "onCycleFilteredClicked",
        "onDisplayClicked",
        "onTableClicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'onCycleAllClicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onCycleFilteredClicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onDisplayClicked'
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onCycleAllClicked(); break;
        case 1: _t->onCycleFilteredClicked(); break;
        case 2: _t->onDisplayClicked(); break;
